...
export const config = {
  ...
  ODOO: {
    BASE_URL: __DEV__ 
      ? 'http://103.67.244.254:8069'  // Development
      : 'http://103.67.244.254:8069', // Production (same for now)
    DATABASE: __DEV__ ? 'development' : 'production', // Use production DB for production builds
    USERNAME: 'zakariali0705@gmail.com',
    PASSWORD: 'admin',
    API_KEY: 'bd598ce6e94176c354da8333ea381b854617175f',
    API_VERSION: 'v1',
  },
  ...
  SOCIAL_LOGIN: {
    GOOGLE: {
      IOS_CLIENT_ID: '813145283633-m76ed93hla2i35nb7r3dfd7cgrjauh12.apps.googleusercontent.com',
      ANDROID_CLIENT_ID: '813145283633-7aroaegs4gb8gj4pa9nar776va9grnck.apps.googleusercontent.com',
      WEB_CLIENT_ID: '813145283633-c7gs0rsc79cas7dt23vu7b19m9hsue1p.apps.googleusercontent.com',
    },
    FACEBOOK: {
      APP_ID: '797841592820309',
    },
  },
  ...
  WHATSAPP: {
    PROVIDER: 'fonnte',
    FONNTE_TOKEN: 'foUxAsfeYPs5CpBoTz6q',
  ...
  // Debug Configuration
  DEBUG: __DEV__, // Same as EXPO_PUBLIC_DEBUG=true in .env
  
  // Network Debugging
  LOG_API_CALLS: __DEV__ ? true : false, // Enable only in development
  LOG_ERRORS: true,
};
