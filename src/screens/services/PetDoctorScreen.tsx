...
export default function PetDoctorScreen() {
  ...
  return (
    <>
      <StatusBar barStyle="light-content" backgroundColor="#00A6F5" />
      <LinearGradient
        colors={['#00A6F5', '#00BCD4']}
          ...
          <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.contentSection}>
              ...
              <Text style={styles.subtitle}>
                Silakan pilih cara yang paling nyaman untuk konsultasi dengan dokter hewan.
              </Text>
              ...
              <View style={styles.serviceOptionHeader}>
                ...
                <View style={styles.serviceOptionContent}>
                  ...
                  <Text style={styles.serviceOptionDescription}>
                    Kamu menjadwalkan mau datang ke clinic.
                  </Text>
                </View>
              </View>
            </TouchableOpacity>
            ...
            >
              <View style={styles.serviceOptionHeader}>
                ...
                <View style={styles.serviceOptionContent}>
                  ...
                  <Text style={styles.serviceOptionDescription}>
                    Kamu menjadwalkan dokter hewan datang ke rumah.
                  </Text>
                </View>
              </View>
            </TouchableOpacity>
